...
root_path = "/home/krieglera/Projects/phd_geometric_learning/PrimitivePose Annotation"
...
if __name__ == "__main__":
    ...
    for cam_number in cam_numbers:
        camera_objs = [cam for cam in bpy.data.objects if (cam.type == 'CAMERA' and (('view_' + cam_number) in str(cam.name)))]
